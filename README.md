...
🚀 今後の展望
今後は、アプリケーション全体をNext.jsで再構築していくことを目標にしています。現在はTypeScriptを学習中であり、これからReactやNext.jsも習得しながら、現在のLaravelバックエンドも含めて技術スタックを統一していく計画です。最終的には、これらの技術を用いて質問投稿機能の実装やUI/UXの改善を行い、アプリケーションの完成を目指します。
